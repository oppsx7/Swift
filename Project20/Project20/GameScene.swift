...
class GameScene: SKScene {
    ...
    @objc func lauchFireWorks() {
        ...
        case 3:
            createFireWork(xMovement: movementAmount, x: rightEdge + 400, y: bottomEdge)
            createFireWork(xMovement: movementAmount, x: rightEdge + 300, y: bottomEdge)
            createFireWork(xMovement: movementAmount, x: rightEdge + 200, y: bottomEdge)
            createFireWork(xMovement: movementAmount, x: rightEdge + 100, y: bottomEdge)
